...
Declaramos la función changeToList, esta tomara el numero del tab según el "id" establecido en el botón y en base a su valor colocaremos el titulo a pasar en la navegación.
