...
<img style="float: left; margin: 5px;" src="{{site.baseurl}}/Images/Pantalla_menu.png">
<br>
Vista del Menú
...
<img style="float: left; margin: 5px;" src="{{site.baseurl}}/Images/Pantalla_categorias.png">
<br>
Pantalla de Presentación de Categorías
...
<img style="float: left; margin: 5px;" src="{{site.baseurl}}/Images/Pantalla_platos.png">
<br>
Pantalla de Lista de Platos	
...
<img style="float: left; margin: 5px;" src="{{site.baseurl}}/Images/Pantalla_detalle_p.png">
<br>
Pantalla de Detalle del Plato
...
<img style="float: left; margin: 5px;" src="{{site.baseurl}}/Images/Pantalla_informacion.png">
<br>
Pantalla de Información
...
<img style="float: left; margin: 5px;" src="{{site.baseurl}}/Images/Pantalla_ubicacion.png">
<br>
...
<img style="float: left; margin: 5px;" src="{{site.baseurl}}/Images/Pantalla_comollegar.png">
<br>
Pantalla de Detalle de Ubicación
...
<img style="float: left; margin: 5px;" src="{{site.baseurl}}/Images/Pantalla_contacto.png">
<br>
Pantalla de Contacto
...
<img style="float: left; margin: 5px;" src="{{site.baseurl}}/Images/Pantalla_contactar.png">
<br>
Pantalla para Contactar
...
<img style="float: left; margin: 5px;" src="{{site.baseurl}}/Images/Pantalla_inicio.png">
<br>
Splash para el inicio de la aplicación
